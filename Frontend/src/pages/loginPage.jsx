        ...
        <div className="backdrop-blur-md bg-black/10 border border-white/20 shadow-2xl rounded-2xl p-8 flex flex-col gap-3 text-white transition-all hover:scale-[1.02] duration-300 w-[350px]">
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-10 px-4 mt-1 rounded-xl bg-white/30 border border-bordercolor text-accent placeholder-accent focus:outline-none focus:ring-2 focus:ring-accent"
            />
          </div>
          ...
          <button
            onClick={login}
            className="w-full h-10 rounded-xl bg-gradient-to-r from-green- to-accent text-white font-semibold hover:opacity-90 transition-all duration-300 shadow-lg"
          >
            Login
          </button>
